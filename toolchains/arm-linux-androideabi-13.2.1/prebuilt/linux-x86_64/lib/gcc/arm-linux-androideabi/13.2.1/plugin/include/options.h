...
enum opt_code
{
  ...
  OPT_mneon_for_64bits = 1924,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1925,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1926,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1927,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1928,               /* -mprint-tune-info */
  OPT_mpure_code = 1929,                     /* -mpure-code */
  OPT_mrestrict_it = 1930,                   /* -mrestrict-it */
  OPT_msched_prolog = 1931,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1932,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1933,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1934, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1935, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1936,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1937,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1938,                         /* -mthumb */
  OPT_mthumb_interwork = 1939,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1940,                  /* -mtls-dialect= */
  OPT_mtp_ = 1941,                           /* -mtp= */
  OPT_mtpcs_frame = 1942,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1943,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1944,                         /* -mtune= */
  OPT_muclibc = 1945,                        /* -muclibc */
  OPT_munaligned_access = 1946,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1947,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1948,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1949,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1950,              /* -mword-relocations */
  OPT_n = 1951,                              /* -n */
  ...
  OPT_pie = 1972,                            /* -pie */
  OPT_pipe = 1973,                           /* -pipe */
  OPT_posix = 1974,                          /* -posix */
  OPT_print_file_name_ = 1975,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1976,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1977,          /* -print-multi-directory */
  OPT_print_multi_lib = 1978,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1979,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1980,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1981,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1982,               /* -print-prog-name= */
  OPT_print_search_dirs = 1983,              /* -print-search-dirs */
  OPT_print_sysroot = 1984,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1985,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1986,                    /* -print-value */
  OPT_profile = 1987,                        /* -profile */
  OPT_pthread = 1988,                        /* -pthread */
  OPT_quiet = 1989,                          /* -quiet */
  OPT_r = 1990,                              /* -r */
  OPT_rdynamic = 1991,                       /* -rdynamic */
  OPT_remap = 1992,                          /* -remap */
  OPT_reverse_sort = 1993,                   /* -reverse-sort */
  OPT_s = 1994,                              /* -s */
  OPT_save_temps = 1995,                     /* -save-temps */
  OPT_save_temps_ = 1996,                    /* -save-temps= */
  OPT_shared = 1997,                         /* -shared */
  OPT_shared_libgcc = 1998,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1999,               /* -shared-libphobos */
  OPT_size_sort = 2000,                      /* -size-sort */
  /* OPT_specs = 2001, */                    /* -specs */
  OPT_specs_ = 2002,                         /* -specs= */
  OPT_static = 2003,                         /* -static */
  OPT_static_libasan = 2004,                 /* -static-libasan */
  OPT_static_libgcc = 2005,                  /* -static-libgcc */
  OPT_static_libgfortran = 2006,             /* -static-libgfortran */
  OPT_static_libgm2 = 2007,                  /* -static-libgm2 */
  OPT_static_libgo = 2008,                   /* -static-libgo */
  OPT_static_libhwasan = 2009,               /* -static-libhwasan */
  OPT_static_liblsan = 2010,                 /* -static-liblsan */
  OPT_static_libmpx = 2011,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2012,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2013,               /* -static-libphobos */
  OPT_static_libquadmath = 2014,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2015,               /* -static-libstdc++ */
  OPT_static_libtsan = 2016,                 /* -static-libtsan */
  OPT_static_libubsan = 2017,                /* -static-libubsan */
  OPT_static_pie = 2018,                     /* -static-pie */
  /* OPT_std_c__03 = 2019, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2020, */                /* -std=c++0x */
  OPT_std_c__11 = 2021,                      /* -std=c++11 */
  OPT_std_c__14 = 2022,                      /* -std=c++14 */
  OPT_std_c__17 = 2023,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2024, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2025, */                /* -std=c++1z */
  OPT_std_c__20 = 2026,                      /* -std=c++20 */
  OPT_std_c__23 = 2027,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2028, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2029, */                /* -std=c++2b */
  ...
  /* OPT_std_gnu__2a = 2055, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2056, */              /* -std=gnu++2b */
  ...
  OPT_time = 2079,                           /* -time */
  OPT_time_ = 2080,                          /* -time= */
  OPT_tno_android_cc = 2081,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2082,                 /* -tno-android-ld */
